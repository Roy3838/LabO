...
# Referencia medida
Isample[:,:,1] = convert.(N0f8,(Gray.(imresize(load("6_LabOptica/NuevosSamplesReto/Samples_29Abril/Huevo Chido/Referencia 1.JPG"),tamano[1:2]))));
